#
#  Be sure to run `pod spec lint FadeInFadeOutCP.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "point_zg" => "point_zg@163.com" }
  ...
  spec.preserve_paths = "FadeInFadeOutCP/FadeInFadeOutCP.framework"
